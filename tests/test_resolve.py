...
from tests.conftest import GATEWAY_SECRET_VALUE, build_graph, repo_writer, write_sample_repo


def test_explicit_http_call_from_configmap(tmp_path):
    graph = build_graph(write_sample_repo(tmp_path))
...
def test_match_selector_requires_unique_match():
    ...
    from kubedian.application.pipeline.resolve import _match_selector, _ServiceIndex
